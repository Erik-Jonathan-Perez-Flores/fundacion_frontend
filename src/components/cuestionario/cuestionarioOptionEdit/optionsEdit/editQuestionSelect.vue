<template>
    <div>
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
         <h3 align="center">Pregunta de selección </h3>
       </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div v-if="OptionSelect.length>0">
                ...
                <div class="col-lg-4 col-md-3 col-sm-2 col-xs-12">
                    ...
                    {{op.TitleOption}}&nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-danger btn-xs"><i class="fa fa-window-close" aria-hidden="true" v-on:click="deleteOpcions(index)"></i></button>
                  </label>
                </div>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-lg-offset-9 col-md-4 col-md-offset-8 col-sm-12 col-xs-12">
         ...
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <p class="text-danger ErrorHideOption" style="display:none">{{errors.opcionCantidad}}</p>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
          <div class="form-group pull-right">
              <button type="button" class="btn btn-success btn-md  buttonsave" v-on:click.prevent="insertQuestionSelect">Actualizar</button>
...
<script>
	export default{
		name:'editQuestionSelect',
		props:['positionQuestion','dataQuestion'],
		data(){
        return{
            preguntatext:this.dataQuestion.questionText,
            textOption:'',
            oblitex:this.dataQuestion.requiredQuestion,
            OptionSelect:this.dataQuestion.option,
            OptionSelectCancel:[],
            errors:{
		...
		methods:{
            ...
            this.$eventbus.$emit('preguntaSelectEdit',{
	        ...
	        cancelarInsert:function(){
	        	this.$eventbus.$emit('cancelEditSelect')
	        }
		}
	}
</script>
